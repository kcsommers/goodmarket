...
class SignUpForm(forms.ModelForm):
  ...
  class Meta:
      ...
      widgets = {
        'first_name': forms.TextInput(attrs={'class': 'signup-p1', 'placeholder': 'First Name'}),
        'last_name': forms.TextInput(attrs={'class': 'signup-p1', 'placeholder': 'Last Name'}),
        'email': forms.TextInput(attrs={'class': 'signup-p1', 'placeholder': 'Email'})
      }
